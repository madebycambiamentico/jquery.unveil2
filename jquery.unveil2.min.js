 ...
 */
!function(t,n){Image.prototype.udata=document.body.dataset?function(t){return this.dataset[t]}:function(t){return this.getAttribute("data-"+t)},n.fn.unveil=function(e,i){function o(){var t=a.filter(function(){return null!==this.offsetParent&&((l=this.getBoundingClientRect()).top>=e.thr[0]&&l.top<=c-e.thr[1]||l.top<=e.thr[0]&&l.bottom>=c-e.thr[1]||this.offsetTop<=e.thr[0])});return r=t.addClass(e.uclass).trigger("unveil"),(a=a.not(r)).length}function s(){var t=u.scrollTop();d===t?f(s):(d=t,o()||!e.hasEnd?f(s):u.off(".unveil"))}var r,a=this,u=n(t);e=n.extend({thr:[0,0],uclass:"unveiled",lclass:"loaded",hasEnd:void 0===i},e),i?(i.options=function(t){return e=n.extend(e,t)},i.addImgs=function(t){return a.add(t)},i.delImgs=function(t){return a=a.not(t)},"callback"in i||(i.callback=n.noop)):i={callback:n.noop},a.one("unveil",function(){var t=this.udata("src");t&&(this.onload=function(){this.className+=" "+e.lclass,i.callback(this)},this.src=t)});var l,c=u.height();u.on("resize.unveil",function(){c=u.height()});var f=t.requestAnimationFrame||t.webkitRequestAnimationFrame||t.mozRequestAnimationFrame||t.msRequestAnimationFrame||t.oRequestAnimationFrame||!1;if(f){console.info("Using requestAnimationFrame for unveil detection");var d=u.scrollTop();u.on("resize.unveil",function(){d--,f(s)}),s()}else{console.info("Using scroll event 100ms for unveil detection");var h,m=!1;u.on("scroll.unveil resize.unveil",function(){m||(m=!0,clearTimeout(h),o(),setTimeout(function(){m=!1},100),h=setTimeout(function(){!o()&&e.hasEnd&&u.off(".unveil")},200))})}return o(),this}}(window,jQuery);
